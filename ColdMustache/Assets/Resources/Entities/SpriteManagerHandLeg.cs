...
public class SpriteManagerHandLeg : SpriteManagerGeneric
{
    ...
    * 9 - LEGS      THIS SPRITE WILL BE IGNORED ITS JUST LOADED HERE AND FROM HERE HumanLegsManager WILL STEAL IT
    * 10- LEGWEAR   the first 3 sprites will be used, but it also is mostly here to get stolen by legManager
    *
    * 
    * 
    * SPRITE RENDERERS:
    ...
    *
    * 14 - Legwear (the part over lower body)
    *
    * 
    * 
    */
    ...
    //its only purpose is to force update on him when temporary color activates and runs out
                ...
                for (int i = 0; i < Length; i++)
                {
                    switch (i)
                    {
                        ...
                        case 13:
                            ...
                            break;
                        case 14: //legwear (part on lower body)
                            spriteRenderers[14].sprite = sprites[10][1];
                            spriteRenderers[14].color = colors[10];
                ...
                for (int i = 0; i < Length; i++)
                {
                    switch (i)
                    {
                        ...
                        case 13:
                            ...
                            break;
                        case 14: //legwear (part on lower body)
                            spriteRenderers[14].sprite = sprites[10][2];
                            spriteRenderers[14].color = colors[10];
                            spriteRenderers[i].flipX = false;
                            break;
                        default:
                ...
                for (int i = 0; i < Length; i++)
                {
                    switch (i)
                    {
                        ...
                        case 13:
                            ...
                            break;
                        case 14: //legwear (part on lower body)
                            spriteRenderers[14].sprite = sprites[10][0];
                            spriteRenderers[14].color = colors[10];
                            spriteRenderers[i].flipX = false;
                            break;
                        default:
    ...
    public override void TemporaryColor(Color color, float Time){
        base.TemporaryColor(color, Time);
        LegsManager.ResetSpriteSet();
    }

    public override void EndTemporaryColor(){
        base.EndTemporaryColor();
        LegsManager.ResetSpriteSet();
    }
