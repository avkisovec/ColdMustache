...
public class InflicterSlow : Inflicter {
    ...
    public override void Inflict(GameObject Target)
    {
        Target.gameObject.AddComponent<StatusSlow>().ini(DurationSeconds, Coefficient, SpawnParticles);
    }
}
